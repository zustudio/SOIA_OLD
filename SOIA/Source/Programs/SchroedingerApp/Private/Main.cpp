...
int main()
{
	...
	LOGSTATUS("Registered W. Now equals to " + std::to_string(runtime.CalculateValue("W")));
...
*/
	...
	auto pObj = D1D1GenericFunction(&runtime, runtime.GetElement<Value>("RPP")->GetID());
	auto psiObj = D1D1GenericFunction(&runtime, runtime.GetElement<Value>("Psi")->GetID());
	auto w_pot_Obj = D1D1GenericFunction(&runtime, runtime.GetElement<Value>("SLD_W_pot")->GetID());
